...
- **Subjects**: helpers in `gsm-bus` enforce the naming convention so strings aren’t scattered. Configure env/tenant/team/platform as usual; team is already sanitised at ingress.
